...
`,$o=()=>{const{user:n,setUser:t}=r.useContext(q),{tasks:s,settings:u,emojisStyle:g}=n,{selectedTaskId:c,anchorEl:o,anchorPosition:h,multipleSelectedTasks:D,handleSelectTask:b,setEditModalOpen:$,handleDeleteTask:R,handleCloseMoreMenu:x}=r.useContext(We),[v,p]=r.useState(!1),y=_e(),k=en(),I=Re(),l=r.useMemo(()=>s.find(T=>T.id===c)||{},[c,s]),B=()=>{const T=l==null?void 0:l.id.toString().replace(".","");k(`/task/${T}`)},m=()=>{if(c){x();const T=s.map(w=>w.id===c?{...w,done:!w.done}:w);t(w=>({...w,tasks:T})),T.every(w=>w.done)&&H(e.jsxs("div",{children:[e.jsx("b",{children:"All tasks done"}),e.jsx("br",{}),e.jsx("span",{children:"You've checked off all your todos. Well done!"})]}),{icon:e.jsx("div",{style:{margin:"-6px 4px -6px -6px"},children:e.jsx(Je,{variant:"success",scale:.18})})})}},C=()=>{if(c){x();const T=s.map(f=>f.id===c?{...f,pinned:!f.pinned}:f);t(f=>({...f,tasks:T}))}},V=()=>{if(x(),c&&l){const T={...l,id:ze(),date:new Date,lastSave:void 0},f=[...s,T];t(w=>({...w,tasks:f}))}},J=()=>{var re;const f=(window.speechSynthesis.getVoices()??[]).find(F=>F.name===u.voice.split("::")[0]),w=u.voiceVolume,ue=l.name?l.name+". ":"",te=l!=null&&l.description?((re=l==null?void 0:l.description)==null?void 0:re.replace(/((?:https?):\/\/[^\s/$.?#].[^\s]*)/gi,""))+". ":"",se=new Intl.DateTimeFormat(f?f.lang:navigator.language,{dateStyle:"full",timeStyle:"short"}).format(new Date((l==null?void 0:l.date)||"")),ie=l!=null&&l.deadline?`. Task Deadline: ${Qe(new Date(l.deadline),f?f.lang:navigator.language)}`:"",W=`${ue}${te}Date: ${se}${ie}`,O=new SpeechSynthesisUtterance(W);f&&(O.voice=f),w&&(O.volume=w),x();const ae=()=>{window.speechSynthesis.pause()},M=()=>{window.speechSynthesis.resume()},me=()=>{window.speechSynthesis.cancel(),fe.dismiss(Y),x()},Y=fe(()=>{var le;const[F,K]=r.useState(!0);return e.jsxs(Ro,{children:[e.jsxs(Io,{translate:"yes",children:[e.jsx(kn,{})," Read aloud: ",e.jsx("span",{translate:"no",children:l==null?void 0:l.name})]}),e.jsxs("span",{translate:"yes",style:{marginTop:"8px",fontSize:"16px"},children:["Voice: ",e.jsx("span",{translate:"no",children:((le=O.voice)==null?void 0:le.name)||"Default"})]}),e.jsx("div",{translate:"no",children:e.jsx(on,{delay:.6,play:F,children:e.jsxs("p",{style:{margin:"6px 0"},children:[O.text,"  "]})})}),e.jsxs(Lo,{children:[F?e.jsx(U,{onClick:()=>{ae(),K(!F)},children:e.jsx(Dn,{fontSize:"large"})}):e.jsx(U,{onClick:()=>{M(),K(!F)},children:e.jsx($n,{fontSize:"large"})}),e.jsx(U,{onClick:me,children:e.jsx(Tn,{fontSize:"large"})})]})]})},{duration:1/0,style:{border:`1px solid ${I.darkmode?"#1b1d4eb7":"#ededf7b0"} `,WebkitBackdropFilter:`blur(${I.darkmode?"10":"14"}px)`,backdropFilter:`blur(${I.darkmode?"10":"14"}px)`}});O.onend=()=>{x(),fe.dismiss(Y)},w>0&&window.speechSynthesis.speak(O)},z=e.jsxs("div",{children:[e.jsxs(P,{onClick:m,children:[l.done?e.jsx(Ve,{}):e.jsx(bn,{}),"  ",l.done?"Mark as not done":"Mark as done"]}),e.jsxs(P,{onClick:C,children:[e.jsx(Fe,{sx:{textDecoration:"line-through"}}),"  ",l.pinned?"Unpin":"Pin"]}),D.length===0&&e.jsxs(P,{onClick:()=>b(c||ze()),children:[e.jsx(Te,{}),"   Select"]}),e.jsxs(P,{onClick:B,children:[e.jsx(yn,{}),"   Task details"]}),u.enableReadAloud&&"speechSynthesis"in window&&e.jsxs(P,{onClick:J,disabled:window.speechSynthesis&&(window.speechSynthesis.speaking||window.speechSynthesis.pending),children:[e.jsx(Cn,{}),"   Read Aloud"]}),e.jsxs(P,{onClick:()=>{p(!0),x()},children:[e.jsx(we,{}),"   Share"]}),e.jsx(ge,{}),e.jsxs(P,{onClick:()=>{$(!0),x()},children:[e.jsx(Sn,{}),"   Edit"]}),e.jsxs(P,{onClick:V,children:[e.jsx(wn,{}),"   Duplicate"]}),e.jsx(ge,{}),e.jsxs(P,{clr:N.red,onClick:()=>{R(),x()},children:[e.jsx(ve,{}),"   Delete"]})]});return e.jsxs(e.Fragment,{children:[y?e.jsx(nn,{open:!!o,onDismiss:x,snapPoints:({minHeight:T,maxHeight:f})=>[T,f],expandOnContentDrag:!0,header:e.jsxs("div",{style:{cursor:"ns-resize"},children:[e.jsxs(To,{translate:"no",children:[e.jsx(Ue,{emojiStyle:g,size:32,unified:l.emoji||""})," ",g===sn.NATIVE&&"  ",l.name]}),e.jsx(ge,{sx:{mt:"20px",mb:"-20px"}})]}),children:e.jsx(Eo,{children:z})}):e.jsx(vn,{id:"task-menu",anchorEl:o,anchorPosition:h||void 0,anchorReference:h?"anchorPosition":void 0,open:!!o,onClose:x,sx:{"& .MuiPaper-root":{borderRadius:"18px",minWidth:"200px",boxShadow:"none",padding:"6px 4px"}},MenuListProps:{"aria-labelledby":"more-button"},children:z}),e.jsx(Co,{open:v,onClose:()=>p(!1),selectedTask:l})]})},To=d.h3`
  display: flex;
  justify-content: center;
  align-items: center;
  gap: 6px;
